...
from tket.platform.helios import HELIOS_CONFIG_META_KEY, set_platform_config
...
def test_set_platform_config_custom_hugr() -> None:
    ...
    set_platform_config(hugr, squash_rxys=False, enable_dd=True)
