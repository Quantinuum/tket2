...
def test_cost():
    circ = TkProgram.from_tket1(Circuit(4).CX(0, 1).H(1).CX(1, 2).CX(0, 3).H(0))
...
def test_hash():
    circA = TkProgram.from_tket1(Circuit(4).CX(0, 1).CX(1, 2).CX(0, 3))
    circB = TkProgram.from_tket1(Circuit(4).CX(1, 2).CX(0, 1).CX(0, 3))
    circC = TkProgram.from_tket1(Circuit(4).CX(0, 1).CX(0, 3).CX(1, 2))
...
def test_conversion():
    ...
    tk2 = TkProgram.from_tket1(tk1)
    mermaid = tk2.render_mermaid()

    assert type(tk2) is TkProgram
