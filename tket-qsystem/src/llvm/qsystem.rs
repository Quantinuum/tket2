    ...
    fn emit<'c, H: HugrView<Node = Node>>(
        ...
        match op {
            ...
            QSystemOp::FutureToMeasurement => {
                unreachable!("Op `FutureToMeasurement` should have been removed before codegen")
            }
        }
    }
