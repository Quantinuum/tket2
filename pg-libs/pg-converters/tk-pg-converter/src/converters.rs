...
use tk_pg_core::{GateData, GateType, Op, Pauli, PauliGraph, RotationData, TableauData};
use uuid::Uuid;
        ...
        match optype {
            ...
            "UnitaryTableauBox" => {
                ...
                for i in 0..n_qubits {
                    ...
                    // TKET and tk-pg-core both use true for a -1 phase.
...
mod tests {
    use super::*;
    use rstest::rstest;
    use tk_pg_core::{BlackBoxData, ConditionalBoxData};
