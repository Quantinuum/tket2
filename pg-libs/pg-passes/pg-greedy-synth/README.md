...
See [ARCHITECTURE.md](https://github.com/Quantinuum/tket2/blob/main/pg-libs/pg-passes/pg-greedy-synth/ARCHITECTURE.md) for an overview of the internal design.
See [TUNING.md](https://github.com/Quantinuum/tket2/blob/main/pg-libs/pg-passes/pg-greedy-synth/TUNING.md) for internal tuning constants.
