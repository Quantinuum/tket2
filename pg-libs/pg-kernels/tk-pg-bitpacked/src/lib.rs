...
///
/// ```
/// use tk_pg_bitpacked::bools_to_u64_vec;
...
/// ```
/// use tk_pg_core::Pauli;
/// use tk_pg_bitpacked::paulis_to_u64s;
...
/// ```
/// use tk_pg_core::Pauli;
/// use tk_pg_bitpacked::u64s_to_paulis;
...
///
/// ```
/// use tk_pg_bitpacked::sign_flips_to_u64s;
/// // indices 0 and 2 are true → bits 0 and 2 set → 0b0101 = 5
...
///
/// ```
/// use tk_pg_bitpacked::u64s_to_sign_flips;
