//! Structural analysis for CFG structuralization.
//!
//! This module takes the generic RVSDG control tree and enriches it with the
...
pub(super) fn analyze_cfg_region<H: HugrView<Node = Node>>(
    cfg_view: &H,
